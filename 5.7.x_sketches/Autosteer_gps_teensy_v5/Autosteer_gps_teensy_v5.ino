      ...
      if (client.available()) {
       ...
       // Serial.write(c);
        ...
        if (c == '\n' && currentLineIsBlank) {
         ...
         client.println("<br />");
          client.println("www.autosteer.cc Autosteer PCB Status page");
          client.println("<br />");
          client.println("<br />");
          int sensorReading = digitalRead(32);  // read work switch
          client.print("Steerswitch input ");
          client.print(" is ");
          client.print(sensorReading);
          client.println("<br />");

          sensorReading = digitalRead(34); //read auto steer enable switch open = 0n closed = Off
          client.print("Works input ");
          client.print(" is ");
          client.print(sensorReading);
          client.println("<br />");

          sensorReading = digitalRead(37); //read auto steer enable switch open = 0n closed = Off
          client.print("Remote input ");
          client.print(" is ");
          client.print(sensorReading);
          client.println("<br />");

          sensorReading = analogRead(41); //read auto steer enable switch open = 0n closed = Off
          client.print("Ampere input (0-5) ");
          client.print(" is ");
          client.print(sensorReading);
          client.println("<br />");

          sensorReading = analogRead(24); //read auto steer enable switch open = 0n closed = Off
          client.print("Pressure input (0-5) ");
          client.print(" is ");
          client.print(sensorReading);
          client.println("<br />");

          sensorReading = analogRead(26); //read auto steer enable switch open = 0n closed = Off
          client.print("Volt input (0-12) ");
          client.print(" is ");
          client.print(sensorReading);
          client.println("<br />");

          sensorReading = analogRead(27); //read auto steer enable switch open = 0n closed = Off
          client.print("Volt input (0-12) ");
          client.print(" is ");
          client.print(sensorReading);
          client.println("<br />");
